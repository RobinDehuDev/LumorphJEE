...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
	...
	<ul class="menu-list">
		...
		<logic:equal name="page" value="1">
			<li class="menu-item-selected"><a href="/Ludomorph/template.do?page=1" class="menu-link">Mon héro</a></li>
		</logic:equal>
		<logic:notEqual name="page" value="1">
			<li class="menu-item"><a href="/Ludomorph/template.do?page=1" class="menu-link">Mon héro</a></li>
		</logic:notEqual>
			
		<logic:equal name="page" value="2">
			<li class="menu-item-selected"><a href="" class="menu-link">Mes musiques</a></li>
		</logic:equal>
		<logic:notEqual name="page" value="2">
			<li class="menu-item"><a href="" class="menu-link">Mes musiques</a></li>
		</logic:notEqual>
